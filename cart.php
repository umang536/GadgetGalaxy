...
?>				
					<ul  class="pro__prize">
												...
												<td class="product-subtotal"><?php echo (int)$qty * (int)$price; ?></td>
                                                <td class="product-remove"><a href="javascript:void(0)" onclick="manage_cart_update('<?php echo $key?>','remove')"><i class="icon-trash icons"></i></a></td>
											</tr>
										<?php } } } ?>
                                    </tbody>
                                </table>
